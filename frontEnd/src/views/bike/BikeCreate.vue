...
const form = reactive({} as BikeForm)
  ...
  <v-container>
    ...
    <v-form>
      <v-row>
        ...
        <v-col cols="12" md="6">
          <v-text-field v-model="form.streetLegal" label="streetLegal" required></v-text-field>
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field v-model="form.backSeat" label="backSeat" required></v-text-field>
        </v-col>
        <v-col cols="12">
